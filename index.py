...
def analysis():
	...
	for url in urls:
		...
		results.append({"headline": article.title, "summary": summary2, "_summary": str_summary, "image": article.top_image, "subjectivity": subj_sum, "p_group": pol_sum, "url": url})
	...
	return json.dumps({"status": 200, "results": results})
